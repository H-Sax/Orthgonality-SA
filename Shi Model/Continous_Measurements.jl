...
circ_time_idxs_chunked = function (p)
  ...
  for k in 1:chunks
      ...
      @time "    Results processed in" Threads.@threads for i in 1:chunksize
        ...
        tsol = sol[i].t
        LV_V = sol[i][1,:]
        out[1:300,i+offset] = LV_p(LV_V,tsol, pchunk[:,i])
        out[301:600,i+offset] = sol[i][5,:]
        out[601:900,i+offset] = LV_V
      end
  end
...
@time Sobol_HS_C = gsa(circ_time_idxs_chunked,Sobol(),A,B,batch = true, Ei_estimator = :Homma1996)
serialize("Sobol_HS_C.jls", Sobol_HS_C)



println("Sobol Estimator - Sobol")
@time Sobol_SS_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Sobol2007)
serialize("Sobol_SS_C.jls", Sobol_SS_C)


println("Jansen Estimator - Sobol")
@time Sobol_JS_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Jansen1999)
serialize("Sobol_JS_C.jls", Sobol_JS_C)


println("Janon Estimator - Sobol")
@time Sobol_JaS_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Janon2014)
serialize("Sobol_JaS_C.jls", Sobol_JaS_C)
...
@time Sobol_HLR_C = gsa(circ_time_idxs_chunked,Sobol(),A,B,batch = true, Ei_estimator = :Homma1996)
serialize("Sobol_HLR_C.jls", Sobol_HLR_C)

println("Sobol Estimator - Lattice Rule")
@time Sobol_SLR_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Sobol2007)
serialize("Sobol_SLR_C.jls", Sobol_SLR_C)

println("Jansen Estimator - Lattice Rule")
@time Sobol_JLR_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Jansen1999)
serialize("Sobol_JLR_C.jls", Sobol_JLR_C)

println("Janon Estimator - Lattice Rule")
@time Sobol_JaLR_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Janon2014)
serialize("Sobol_JaLR_C.jls", Sobol_JaLR_C)
...
@time Sobol_HG_C = gsa(circ_time_idxs_chunked,Sobol(),A,B,batch = true, Ei_estimator = :Homma1996)
serialize("Sobol_HG_C.jls", Sobol_HG_C)


println("Sobol Estimator - Golden")
@time Sobol_SG_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Sobol2007)
serialize("Sobol_SG_C.jls", Sobol_SG_C)


println("Jansen Estimator - Golden")
@time Sobol_JG_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Jansen1999)
serialize("Sobol_JG_C.jls", Sobol_JG_C)

println("Janon Estimator - Golden")
@time Sobol_JaG_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Janon2014)
serialize("Sobol_JaG_C.jls", Sobol_JaG_C)
...
@time Sobol_HU_C = gsa(circ_time_idxs_chunked,Sobol(),A,B,batch = true, Ei_estimator = :Homma1996)
serialize("Sobol_HU_C.jls", Sobol_HU_C)


println("Sobol Estimator - Uniform")
@time Sobol_SU_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Sobol2007)
serialize("Sobol_SU_C.jls", Sobol_SU_C)


println("Jansen Estimator - Uniform")
@time Sobol_JU_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Jansen1999)
serialize("Sobol_JU_C.jls", Sobol_JU_C)

println("Janon Estimator - Uniform")
@time Sobol_JaU_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Janon2014)
serialize("Sobol_JaU_C.jls", Sobol_JaU_C)
...
println("Homma Estimator - Uniform")
@time Sobol_HLH_C = gsa(circ_time_idxs_chunked,Sobol(),A,B,batch = true, Ei_estimator = :Homma1996)
serialize("Sobol_HLH_C.jls", Sobol_HLH_C)

println("Sobol Estimator - Uniform")
@time Sobol_SLH_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Sobol2007)
serialize("Sobol_SLH_C.jls", Sobol_SLH_C)t

println("Jansen Estimator - Uniform")
@time Sobol_JLH_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Jansen1999)
serialize("Sobol_JLH_C.jls", Sobol_JLH_C)

println("Janon Estimator - Uniform")
@time Sobol_JaLH_C = gsa(circ_time_post,Sobol(),A,B,batch = true, Ei_estimator = :Janon2014)
serialize("Sobol_JaLH_C.jls", Sobol_JaLH_C)
Sobol_JaLH = deserialize("/home/harry/Downloads/Continuous_Measurements/Sobol_JaLH_C.jls")
save("/home/harry/Desktop/PhD/Year 2/GSA project/Shi_Systemic/DATA_all/Janon_C/Sobol_JaLH.jld", "data", Sobol_JaLH.ST)
